...
abstract class BaseSite extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Crina\\SiteManagement\\Model\\SitePeer';
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = SitePeer::IS_ACTIVE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SitePeer::IS_ACTIVE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SitePeer::IS_ACTIVE)) $criteria->add(SitePeer::IS_ACTIVE, $this->is_active);
