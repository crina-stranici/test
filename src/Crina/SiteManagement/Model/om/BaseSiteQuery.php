 ...
 * @method SiteQuery orderByIsActive($order = Criteria::ASC) Order by the is_active column
 ...
 * @method SiteQuery groupByIsActive() Group by the is_active column
 ...
 * @method Site findOneByIsActive(boolean $is_active) Return the first Site filtered by the is_active column
 ...
 * @method array findByIsActive(boolean $is_active) Return Site objects filtered by the is_active column
...
abstract class BaseSiteQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Crina\\SiteManagement\\Model\\Site', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `url`, `is_active`, `created_at` FROM `site` WHERE `id` = :p0';
        try {
    ...
    public function filterByIsActive($isActive = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SitePeer::IS_ACTIVE, $isActive, $comparison);
    }
